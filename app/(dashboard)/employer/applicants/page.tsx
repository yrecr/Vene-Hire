...
import { Search, Star, MessageSquare, ExternalLink } from 'lucide-react';
    ...
    return mockTalentProfiles
      ...
      .filter((t) => {
        ...
        return selectedTags.some(
          (tag) =>
            t.tech_stack.some(
              (tech) => tech.toLowerCase().includes(tag.toLowerCase())
            ) ||
      ...
      .filter((t) => {
        ...
        if (experienceFilter === '1-2 years')
          return t.years_experience >= 1 && t.years_experience <= 2;
        if (experienceFilter === '3-4 years')
          return t.years_experience >= 3 && t.years_experience <= 4;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Search and filter through our vetted talent pool to find the perfect
          fit.
        </p>
      </div>
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    alert(
                      `${applicant.display_name} added to shortlist - This feature is coming soon!`
                    )
                  }
                >
