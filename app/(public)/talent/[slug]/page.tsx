      ...
      <div className="min-h-screen pt-24 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-500 mb-8">
            The talent profile you are looking for does not exist or has been
            removed.
          </p>
          <Link href="/talent">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <Badge
                  variant="outline"
                  className={`${availability.className} px-3 py-1 text-sm font-medium`}
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-white text-gray-700 border-gray-200 px-3 py-1 text-sm font-medium"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {talent.tech_stack.map((tech) => (
                  <Badge
                    key={tech}
                    variant="secondary"
                    className="bg-white shadow-sm border border-gray-200 text-gray-700 px-3 py-1 text-sm"
                  >
                    {tech}
                  </Badge>
                ))}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 text-center shadow-xl">
          ...
          <p className="text-gray-300 mb-8 max-w-xl mx-auto">
            Get in touch to learn more about this candidate or explore our full
            talent pool for your hiring needs.
          </p>
