...
export const mockEmployerProfiles: EmployerProfile[] = [
  { id: 'ep-acme', user_id: 'p-acme', company_name: 'ACME Corp', contact_name: 'Sarah Johnson', summary: 'Global technology company building enterprise SaaS solutions. We are scaling our engineering team across multiple product lines.', hiring_needs: 'Backend Engineers, Full Stack Developers, DevOps Engineers', status: 'active', payment_method: null, payment_details: null, created_at: '2024-03-01' },
  { id: 'ep-innova', user_id: 'p-innova', company_name: 'InnovaSoft', contact_name: 'Ricardo Mendez', summary: 'AI-first startup developing next-generation analytics and automation tools for the financial services industry.', hiring_needs: 'AI Engineers, Python Developers, Data Engineers', status: 'active', payment_method: null, payment_details: null, created_at: '2024-03-05' },
  { id: 'ep-next', user_id: 'p-next', company_name: 'NextLayer', contact_name: 'Michael Chen', summary: 'Cloud infrastructure company providing scalable solutions for mid-market companies in Latin America and the US.', hiring_needs: 'Cloud Engineers, C#/.NET Developers, React Developers', status: 'active', payment_method: null, payment_details: null, created_at: '2024-03-10' },
];
...
export const mockSelectionProcesses: SelectionProcess[] = [
  { id: 'sp1', applicant_id: 'tp-sofia', employer_id: 'ep-acme', role_title: 'Senior Backend Engineer', current_stage: 'technical_interview', status: 'active', intro_interview_date: '2024-04-05T14:00:00Z', technical_interview_date: '2024-04-15T15:00:00Z', meeting_url: 'https://zoom.us/j/123456789?pwd=demo123', contract_status: null, contract_url: null, signature_url: null, hourly_rate: null, contract_start_date: null, contract_end_date: null, notes: 'Strong intro interview. Moving to technical round.', created_at: '2024-04-01' },
  { id: 'sp2', applicant_id: 'tp-daniel', employer_id: 'ep-innova', role_title: 'AI / ML Engineer', current_stage: 'contract_signing', status: 'active', intro_interview_date: '2024-03-20T10:00:00Z', technical_interview_date: '2024-03-28T11:00:00Z', meeting_url: 'https://zoom.us/j/234567890?pwd=demo234', contract_status: 'under_review', contract_url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf', signature_url: '/signatures/daniel-signature.png', hourly_rate: null, contract_start_date: null, contract_end_date: null, notes: 'Excellent performance. Contract sent and signed.', created_at: '2024-03-15' },
  { id: 'sp5', applicant_id: 'tp-valentina', employer_id: 'ep-innova', role_title: 'Frontend Developer', current_stage: 'technical_interview', status: 'not_selected', intro_interview_date: '2024-03-10T09:00:00Z', technical_interview_date: '2024-03-18T10:00:00Z', meeting_url: 'https://zoom.us/j/456789012?pwd=demo456', contract_status: null, contract_url: null, signature_url: null, hourly_rate: null, contract_start_date: null, contract_end_date: null, notes: 'Good candidate but looking for more senior profile.', created_at: '2024-03-05' },
  { id: 'sp6', applicant_id: 'tp-camila', employer_id: 'ep-next', role_title: 'C# / .NET Developer', current_stage: 'contract_signing', status: 'active', intro_interview_date: '2024-04-10T14:00:00Z', technical_interview_date: '2024-04-22T15:00:00Z', meeting_url: 'https://zoom.us/j/567890123?pwd=demo567', contract_status: 'pending', contract_url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf', signature_url: null, hourly_rate: null, contract_start_date: null, contract_end_date: null, notes: 'Great technical performance. Contract ready for signing.', created_at: '2024-04-20' },
];
